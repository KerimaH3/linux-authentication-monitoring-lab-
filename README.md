...
Attempted to switch to the test account using an incorrect password
multiple times:
...
This event demonstrates how administrator privilege changes can be
...
User account creation can be verified through Linux account databases
